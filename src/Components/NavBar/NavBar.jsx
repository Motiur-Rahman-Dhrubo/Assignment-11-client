...
const NavBar = () => {
    ...
    return (
        <nav className="w-full sticky top-0 bg-white/80 shadow-xl backdrop-blur-md border-b border-[#C4C6CA] z-50">
            <div className="navbar w-11/12 mx-auto px-0">
                ...
                <div className="navbar-end">
                    {
                        user ? <button onClick={handleLogout} className="btn btn-primary text-white font-semibold">Logout</button> : <Link to="/login" className="btn btn-primary text-white font-semibold">Login</Link>
                    }
                </div>
            </div>
        </nav>
